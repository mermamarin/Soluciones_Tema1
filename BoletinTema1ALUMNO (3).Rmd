...
## PARA GENERAR SOLO LOS ENUNCIADOS include=FALSE
...
## PARA Incluir la soluciones SOLO LOS ENUNCIADOS include=TRUE
...
d.  Usa la función **intersect** y almacena en la variable *commonAnimals* los aninales que aparezcan en ambos conjuntos
